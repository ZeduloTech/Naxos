...
assign mgmtsoc_litespimmap_bus_cyc = (shared_cyc & slave_sel[2]);
...
always @(*) begin
	shared_ack = 1'd0;
	shared_ack = (((((mgmtsoc_vexriscv_debug_bus_ack | bus_ack) | mgmtsoc_litespimmap_bus_ack) | mprj_ack) | hk_ack) | mgmtsoc_wishbone_ack);
	if (done) begin
		shared_ack = 1'd1;
	end
end
assign shared_err = (((((mgmtsoc_vexriscv_debug_bus_err | bus_err) | mgmtsoc_litespimmap_bus_err) | mprj_err) | hk_err) | mgmtsoc_wishbone_err);
always @(*) begin
	shared_dat_r = 32'd0;
	shared_dat_r = (((((({32{slave_sel_r[0]}} & mgmtsoc_vexriscv_debug_bus_dat_r) | ({32{slave_sel_r[1]}} & bus_dat_r)) | ({32{slave_sel_r[2]}} & mgmtsoc_litespimmap_bus_dat_r)) | ({32{slave_sel_r[3]}} & mprj_dat_r)) | ({32{slave_sel_r[4]}} & hk_dat_r)) | ({32{slave_sel_r[5]}} & mgmtsoc_wishbone_dat_r));
	if (done) begin
...
assign gpioin0_in_status = multiregimpl67_regs1;
assign gpioin1_in_status = multiregimpl68_regs1;
assign gpioin2_in_status = multiregimpl69_regs1;
assign gpioin3_in_status = multiregimpl70_regs1;
assign gpioin4_in_status = multiregimpl71_regs1;
assign gpioin5_in_status = multiregimpl72_regs1;
