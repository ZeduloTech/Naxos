...
#(
  parameter int unsigned NEndpoints = 6, // Number of endpoints supported.(previously 12)
  ...
  parameter int unsigned EpW = prim_util_pkg::vbits(NEndpoints) // derived parameter
) (
  input  logic                  clk_i,
  input  logic                  rst_ni,
