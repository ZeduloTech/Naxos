...
module usbdev #(
        ...
        output logic              sw_mem_a_rvalid_o,
        output logic [1:0]        sw_mem_a_rerror_o,
        output logic [31:0]       sw_mem_a_rdata_o,
        ...
        // Read responses.
        assign sw_mem_a_rdata_o   = sw_mem_a_gnt ? ram_rdata_i : 32'h0;
        assign sw_mem_a_rvalid_o  = ram_rvalid_i & !mem_rsteering & sw_mem_a_gnt;
        assign sw_mem_a_rerror_o  = {2{sw_mem_a_rvalid_o}} & ram_rerror_i;
